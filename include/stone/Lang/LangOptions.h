#ifndef STONE_LANG_LANGOPTIONS_H
#define STONE_LANG_LANGOPTIONS_H
...
public:
  ...
  void SetCurrentTriple(llvm::Triple triple) { currentTargetTriple = triple; }
  /// \ Return the current triple
  const llvm::Triple &GetCurrentTriple() const { return currentTargetTriple; }
  /// \ Return the current triple
  llvm::Triple &GetCurrentTriple() { return currentTargetTriple; }

  /// \ Return the current triple
  bool HasCurrentTriple() const {
    return LangOptions::HasCurrentTriple(currentTargetTriple);
  }

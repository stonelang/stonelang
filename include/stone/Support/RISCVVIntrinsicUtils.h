...
#ifndef STONE_SUPPORT_RISCVVINTRINSICUTILS_H
#define STONE_SUPPORT_RISCVVINTRINSICUTILS_H
...
enum class TypeModifier : uint8_t {
  ...
  // optimization of stone binary size.
  LMUL1 = 1 << 7,
  MaxOffset = 7,
...
public:
  ...
  // Return the stone builtin type for RVV vector type which are used in the
  // riscv_vector.h header file.
  const std::string &getStoneBuiltinStr() const { return StoneBuiltinStr; }
...
#endif // STONE_SUPPORT_RISCVVINTRINSICUTILS_H

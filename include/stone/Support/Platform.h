#ifndef STONE_SUPPORT_PLATFORM_H
#define STONE_SUPPORT_PLATFORM_H
...
std::optional<PlatformKind> PlatformFromString(llvm::StringRef Name);

/// Returns a human-readable version of the platform name as a string, suitable
/// for emission in diagnostics (e.g., "macOS").
llvm::StringRef PrettyPlatformString(PlatformKind platform);

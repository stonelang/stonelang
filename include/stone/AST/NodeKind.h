...
#include <cstdint>
/// \file
/// \brief Defines `NodeKind`, a lightweight enum to classify high-level node
/// categories.
...
/// types, etc.) at a coarse level. This enables quick runtime checks,
/// dispatching, and debugging across the syntax tree without requiring full
/// type introspection.

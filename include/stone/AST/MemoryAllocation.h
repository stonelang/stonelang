#ifndef STONE_AST_MEMORYALLOCATION_H
#define STONE_AST_MEMORYALLOCATION_H
...
/// \c MemoryManager allocator; you cannot allocate them by using a normal \c
/// new, and instead you must either provide an \c MemoryManager or use a
/// placement \c new.
///
...
public:
  ...
  void *operator new(size_t bytes, const MemoryManager &memory,

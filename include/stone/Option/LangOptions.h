#ifndef STONE_OPTION_LANGOPTIONS_H
#define STONE_OPTION_LANGOPTIONS_H
...
class LangOptions final {
  ...
  /// \The primary mode arg that starts a compilation
...
public:
  ...
  bool HasCurrentTriple() const {
    return LangOptions::HasCurrentTriple(currentTriple);
  }

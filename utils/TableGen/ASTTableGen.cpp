...
// for the Stone AST: that is, the contents of files such as DeclNodes.td,
...
llvm::StringRef stone::tblgen::HasProperties::getName() const {
...
std::string stone::tblgen::DeclNode::getClassName() const {
  return (Twine(getName()) + "Decl").str();
}
StringRef stone::tblgen::DeclNode::getId() const {
  return getName();
}

// Type nodes are all named ending in Type, just like the corresponding
// C++ class, and the ID just strips this suffix.
StringRef stone::tblgen::TypeNode::getClassName() const {
  return getName();
}
StringRef stone::tblgen::TypeNode::getId() const {
...
StringRef stone::tblgen::StmtNode::getClassName() const {
  return getName();
}
std::string stone::tblgen::StmtNode::getId() const {
...
void stone::tblgen::visitASTNodeHierarchyImpl(RecordKeeper &records,
                                              StringRef nodeClassName,
                                      ASTNodeHierarchyVisitor<ASTNode> visit) {

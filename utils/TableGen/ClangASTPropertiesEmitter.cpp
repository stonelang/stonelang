//=== StoneASTPropsEmitter.cpp - Generate Stone AST properties --*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This tablegen backend emits code for working with Stone AST properties.
//
//===----------------------------------------------------------------------===//
...
void stone::EmitStoneTypeReader(RecordKeeper &records, raw_ostream &out) {
  emitASTReader<TypeNode>(records, out, "A CRTP reader for Stone Type nodes");
}
...
void stone::EmitStoneTypeWriter(RecordKeeper &records, raw_ostream &out) {
  emitASTWriter<TypeNode>(records, out, "A CRTP writer for Stone Type nodes");
}
...
/// basic values.
void stone::EmitStoneBasicReader(RecordKeeper &records, raw_ostream &out) {
...
/// basic values.
void stone::EmitStoneBasicWriter(RecordKeeper &records, raw_ostream &out) {

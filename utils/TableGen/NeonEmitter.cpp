//===- NeonEmitter.cpp - Generate arm_neon.h for use with stone -*- C++ -*-===//
//
...
//
// See also the documentation in include/stone/Basic/arm_neon.td.
//
//===----------------------------------------------------------------------===//
...
/// include/stone/Basic/TargetBuiltins.h.
...
void stone::EmitNeon(RecordKeeper &Records, raw_ostream &OS) {
  NeonEmitter(Records).run(OS);
}

void stone::EmitFP16(RecordKeeper &Records, raw_ostream &OS) {
  NeonEmitter(Records).runFP16(OS);
}

void stone::EmitBF16(RecordKeeper &Records, raw_ostream &OS) {
  NeonEmitter(Records).runBF16(OS);
}

void stone::EmitNeonSema(RecordKeeper &Records, raw_ostream &OS) {
  NeonEmitter(Records).runHeader(OS);
}

void stone::EmitVectorTypes(RecordKeeper &Records, raw_ostream &OS) {
  NeonEmitter(Records).runVectorTypes(OS);
}

void stone::EmitNeonTest(RecordKeeper &Records, raw_ostream &OS) {

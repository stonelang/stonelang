//===- SveEmitter.cpp - Generate arm_sve.h for use with stone -*- C++ -*-===//
//
...
// by calling a __builtin_-prefixed function which will be handled by stone's
// CodeGen library.
//
// See also the documentation in include/stone/Basic/arm_sve.td.
//
//===----------------------------------------------------------------------===//
...
void Intrinsic::emitIntrinsic(raw_ostream &OS, SVEEmitter &Emitter,
  ...
  OS << (IsOverloaded ? "__aio " : "__ai ")
     << "__attribute__((__stone_arm_builtin_alias(";
...
void SVEEmitter::createHeader(raw_ostream &OS) {
  ...
  OS << "typedef __stone_svint8x2_t svint8x2_t;\n";
  OS << "typedef __stone_svint16x2_t svint16x2_t;\n";
  OS << "typedef __stone_svint32x2_t svint32x2_t;\n";
  OS << "typedef __stone_svint64x2_t svint64x2_t;\n";
  OS << "typedef __stone_svuint8x2_t svuint8x2_t;\n";
  OS << "typedef __stone_svuint16x2_t svuint16x2_t;\n";
  OS << "typedef __stone_svuint32x2_t svuint32x2_t;\n";
  OS << "typedef __stone_svuint64x2_t svuint64x2_t;\n";
  OS << "typedef __stone_svfloat16x2_t svfloat16x2_t;\n";
  OS << "typedef __stone_svfloat32x2_t svfloat32x2_t;\n";
  OS << "typedef __stone_svfloat64x2_t svfloat64x2_t;\n";
  OS << "typedef __stone_svint8x3_t svint8x3_t;\n";
  OS << "typedef __stone_svint16x3_t svint16x3_t;\n";
  OS << "typedef __stone_svint32x3_t svint32x3_t;\n";
  OS << "typedef __stone_svint64x3_t svint64x3_t;\n";
  OS << "typedef __stone_svuint8x3_t svuint8x3_t;\n";
  OS << "typedef __stone_svuint16x3_t svuint16x3_t;\n";
  OS << "typedef __stone_svuint32x3_t svuint32x3_t;\n";
  OS << "typedef __stone_svuint64x3_t svuint64x3_t;\n";
  OS << "typedef __stone_svfloat16x3_t svfloat16x3_t;\n";
  OS << "typedef __stone_svfloat32x3_t svfloat32x3_t;\n";
  OS << "typedef __stone_svfloat64x3_t svfloat64x3_t;\n";
  OS << "typedef __stone_svint8x4_t svint8x4_t;\n";
  OS << "typedef __stone_svint16x4_t svint16x4_t;\n";
  OS << "typedef __stone_svint32x4_t svint32x4_t;\n";
  OS << "typedef __stone_svint64x4_t svint64x4_t;\n";
  OS << "typedef __stone_svuint8x4_t svuint8x4_t;\n";
  OS << "typedef __stone_svuint16x4_t svuint16x4_t;\n";
  OS << "typedef __stone_svuint32x4_t svuint32x4_t;\n";
  OS << "typedef __stone_svuint64x4_t svuint64x4_t;\n";
  OS << "typedef __stone_svfloat16x4_t svfloat16x4_t;\n";
  OS << "typedef __stone_svfloat32x4_t svfloat32x4_t;\n";
  OS << "typedef __stone_svfloat64x4_t svfloat64x4_t;\n";
  OS << "typedef __SVBool_t  svbool_t;\n";
  OS << "typedef __stone_svboolx2_t  svboolx2_t;\n";
  OS << "typedef __stone_svboolx4_t  svboolx4_t;\n\n";

  OS << "typedef __stone_svbfloat16x2_t svbfloat16x2_t;\n";
  OS << "typedef __stone_svbfloat16x3_t svbfloat16x3_t;\n";
  OS << "typedef __stone_svbfloat16x4_t svbfloat16x4_t;\n";
    ...
    for (auto ShortForm : {false, true})
      for (const ReinterpretTypeInfo &To : Reinterprets) {
        ...
        for (const ReinterpretTypeInfo &From : Reinterprets) {
          ...
          OS << "__aio "
                "__attribute__((__stone_arm_builtin_alias(__builtin_sve_"
                "reinterpret_"

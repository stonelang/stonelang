//===--- StoneCommentHTMLTagsEmitter.cpp - Generate HTML tag list for Stone -=//
//
...
void stone::EmitStoneCommentHTMLTags(RecordKeeper &Records, raw_ostream &OS) {
...
void stone::EmitStoneCommentHTMLTagsProperties(RecordKeeper &Records,
                                               raw_ostream &OS) {
  std::vector<Record *> Tags = Records.getAllDerivedDefinitions("Tag");

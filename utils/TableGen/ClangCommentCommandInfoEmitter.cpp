//===--- StoneCommentCommandInfoEmitter.cpp - Generate command lists -----====//
//
...
void stone::EmitStoneCommentCommandInfo(RecordKeeper &Records,
                                        raw_ostream &OS) {
...
void stone::EmitStoneCommentCommandList(RecordKeeper &Records,
                                        raw_ostream &OS) {
  emitSourceFileHeader("A list of commands useable in documentation comments",
                       OS, Records);

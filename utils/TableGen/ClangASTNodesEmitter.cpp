//=== StoneASTNodesEmitter.cpp - Generate Stone AST node tables -*- C++ -*-===//
//
...
using namespace stone::tblgen;

/// StoneASTNodesEmitter - The top-level class emits .inc files containing
///  declarations of Stone statements.
///
namespace {
class StoneASTNodesEmitter {
...
public:
  explicit StoneASTNodesEmitter(RecordKeeper &R, const std::string &N,
                                const std::string &S,
...
std::pair<ASTNode, ASTNode> StoneASTNodesEmitter::EmitNode(raw_ostream &OS,
                                                           ASTNode Base) {
...
void StoneASTNodesEmitter::deriveChildTree() {
...
void StoneASTNodesEmitter::run(raw_ostream &OS) {
  deriveChildTree();
...
void stone::EmitStoneASTNodes(RecordKeeper &RK, raw_ostream &OS,
                              const std::string &N, const std::string &S,
                              std::string_view PriorizeIfSubclassOf) {
  StoneASTNodesEmitter(RK, N, S, PriorizeIfSubclassOf).run(OS);
}
...
// Emits and addendum to a .inc file to enumerate the stone declaration
// contexts.
void stone::EmitStoneDeclContext(RecordKeeper &Records, raw_ostream &OS) {

//=== StoneOpcodesEmitter.cpp - constexpr interpreter opcodes ---*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// These tablegen backends emit Stone AST node tables
//
//===----------------------------------------------------------------------===//
...
namespace {
class StoneOpcodesEmitter {
  RecordKeeper &Records;
  unsigned NumTypes;

public:
  StoneOpcodesEmitter(RecordKeeper &R)
...
void StoneOpcodesEmitter::run(raw_ostream &OS) {
...
void StoneOpcodesEmitter::EmitEnum(raw_ostream &OS, StringRef N,
                                   const Record *R) {
...
void StoneOpcodesEmitter::EmitInterp(raw_ostream &OS, StringRef N,
                                     const Record *R) {
  OS << "#ifdef GET_INTERP\n";
...
void StoneOpcodesEmitter::EmitDisasm(raw_ostream &OS, StringRef N,
                                     const Record *R) {
  OS << "#ifdef GET_DISASM\n";
...
void StoneOpcodesEmitter::EmitEmitter(raw_ostream &OS, StringRef N,
                                      const Record *R) {
...
void StoneOpcodesEmitter::EmitProto(raw_ostream &OS, StringRef N,
                                    const Record *R) {
...
void StoneOpcodesEmitter::EmitGroup(raw_ostream &OS, StringRef N,
                                    const Record *R) {
...
void StoneOpcodesEmitter::EmitEval(raw_ostream &OS, StringRef N,
                                   const Record *R) {
  if (R->getValueAsBit("HasCustomEval"))
    return;
...
void StoneOpcodesEmitter::PrintTypes(raw_ostream &OS,
...
void stone::EmitStoneOpcodes(RecordKeeper &Records, raw_ostream &OS) {
  StoneOpcodesEmitter(Records).run(OS);
}
